...
export const addressFormControls = [
  ...
  },
  {
    ...
    componentType: "input",
    type: "text",
    placeholder: "No, House, Street, Area",
  },
  {
    label: "City / Town",
    name: "city",
  ...
  },
  {
    ...
    componentType: "select",
    options: [
      { id: "lagos", label: "Lagos State" },
      { id: "south-west", label: "South-West (Oyo, Ogun, Osun, Ondo, Ekiti)" },
      { id: "south-east-south", label: "South-East / South-South" },
      { id: "north", label: "North / Abuja" },
    ],
  },
  {
    label: "Email Address",
    ...
    componentType: "input",
    type: "email",
    placeholder: "For receipt & warranty tracking",
  },
  {
