...
export const brandOptionsMap = {
  ...
  hp: "HP",
  lenovo: "Lenovo",
  "google-pixel": "Google Pixel", // Changed from google to Google Pixel
  asus: "Asus",
  lg: "Lg"
};
...
export const filterOptions = {
  ...
  smartphones: {
    brand: [
      { id: "apple", label: "Apple" },
      { id: "samsung", label: "Samsung" },
      { id: "google-pixel", label: "Google Pixel" }, // Changed from google to Google Pixel
    ],
    storage: [
      { id: "64GB", label: "64GB" },
      { id: "128GB", label: "128GB" },
  ...
  monitors: {
    ...
    monitorType: [ // New filter option for monitor sub-category
      { id: "office-monitors", label: "Office Monitors" },
      { id: "gaming-monitors", label: "Gaming Monitors" },
      { id: "curved-monitors", label: "Curved Monitors" },
    ],
...
export const categorySpecificFilters = {
  "all-products": ["category", "priceRange"],
  smartphones: ["brand", "storage", "ram", "condition", "priceRange"],
  laptops: ["brand", "processor", "storage", "ram", "laptopType", "extraFeatures", "condition", "priceRange"], // Changed displayType to extraFeatures
  monitors: ["brand", "screenSize", "frameStyle", "screenResolution", "ports", "monitorType", "condition", "priceRange"], // Added monitorType
  accessories: ["category", "smartphoneAccessories", "laptopAccessories", "monitorAccessories", "otherAccessories", "condition", "priceRange"],
};
