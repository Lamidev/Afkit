...
//       { id: "chargers", label: "Chargers" },
//       { id: "gaming-mouse", label: "Gaming Mouse" },
//       { id: "gaming-keyboard", label: "Gaming Keyboard" },
//       { id: "others", label: "Others" }, // ADD THIS LINE
//     ],
//   },
// };
...
//         filterOptions.accessories.accessoryCategory;
//     } else if (key === "specificAccessory" && category === "accessories") {
//       // This part handles dynamically loading options for specificAccessory
//       const selectedAccessoryCategory =
//         filterOptions.accessories.accessoryCategory.find(
//           (option) => option.id === categorySpecificOptions.accessoryCategory
//         );

//       if (selectedAccessoryCategory) {
//         categorySpecificOptions.specificAccessory =
//           filterOptions.accessories[selectedAccessoryCategory.id] || [];
//       } else {
//         categorySpecificOptions.specificAccessory = [];
//       }
//     }
