          ...
          {productImages.length > 1 && (
            <div className="lg:hidden w-full overflow-x-auto">
              <div 
                ...
                className="flex gap-3 pb-4 hide-scrollbar"
                style={{ scrollBehavior: 'smooth' }}
              >
                {productImages.map((img, index) => (
                  <button
              ...
              <>
                ...
                <div className="mt-8">
                  <a
                    ...
                    className="text-blue-600 hover:underline font-medium inline-flex items-center cursor-pointer"
                  >
                    Need more information about this product, contact us on Whatsapp
                    <svg
